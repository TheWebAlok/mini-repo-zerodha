  ...
  return (
    <footer style={{ backgroundColor: "rgba(250,250,250)" }}>
      ...
      <div  class="d-flex flex-row mb-3 ml-2 ">
        ...
        <div class="p-3 ms-4">BSE</div>
        <div class="p-3 ms-4">MCX</div>
        <div class="p-3 ms-4">Terms & conditions</div>
        <div class="p-3 ms-4"> Policies & procedures</div>
        <div class="p-3 ms-4">Privacy policy</div>
        <div class="p-3 ms-4"> Disclosure</div>
        <div class="p-3 ms-4">For investor attention</div>
        <div class="p-3 ms-4">Investor charter</div>
      </div>
      </div>
    </footer>
  );
