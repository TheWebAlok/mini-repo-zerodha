  ...
  return (
    <div className="container">
      <div className="row  p-5 mt-5 mb-5">
        <h1 className="fs ">To create a ticket, select a relevant topic</h1>
        <div className="col4 p-5 mt-2 mb-2">
          ...
          <a href=""style={{textDecoration: "none", lineHeight: "2.5"}}>Compnay Partnership and HUF Account Opening</a><br/>
        ...
        <div className="col4 p-5 mt-2 mb-2"><h4>
            <i class="fa fa-plus-circle" aria-hidden="true"></i>
        ...
        <div className="col4 p-5 mt-5 mb-2"><h4>
            <i class="fa fa-plus-circle" aria-hidden="true"></i>
            Your Zerodha Account
          </h4>
