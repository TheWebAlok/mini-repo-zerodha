  ...
  return (
    <footer style={{ backgroundColor: "rgba(250,250,250)" }}>
      ...
      <div  class="d-flex flex-row mb-3 ml-2 ">
        ...
        <div class="p-3 ml-">BSE</div>
        <div class="p-3 ml-">MCX</div>
        <div class="p-3 ml-">Terms & conditions</div>
        <div class="p-3 ml-"> Policies & procedures</div>
        <div class="p-3 ml-">Privacy policy</div>
        <div class="p-3 ml-"> Disclosure</div>
        <div class="p-3 ml-">For investor attention</div>
        <div class="p-3 ml-">Investor charter</div>
      </div>
      </div>
    </footer>
  );
