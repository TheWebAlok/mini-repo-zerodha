...
function Footer() {
  return (
    <div className="container">
      ...
      Document as prescribed by SEBI | ICF Procedure to file a complaint on SEBI
      ...
      Dispute Resolution Investments in securities market are subject to market
      ...
      NSDL/CDSL every month. "Prevent unauthorised transactions in your account.
