  ...
  return (
    <footer style={{ backgroundColor: "rgba(250,250,250)" }}>
      ...
      <div  class="d-flex flex-row mb-3 ml-2 ">
        ...
        <div class="p-3 ml-2">BSE</div>
        <div class="p-3 ml-2">MCX</div>
        <div class="p-3 ml-2">Terms & conditions</div>
        <div class="p-3 ml-2"> Policies & procedures</div>
        <div class="p-3 ml-2">Privacy policy</div>
        <div class="p-3 ml-2"> Disclosure</div>
        <div class="p-3 ml-2">For investor attention</div>
        <div class="p-3 ml-2">Investor charter</div>
      </div>
      </div>
    </footer>
  );
