  ...
  return (
    <footer style={{ backgroundColor: "rgba(250,250,250)" }}>
      ...
      <div  class="d-flex flex-row mb-3 ml-2 ">
        ...
        <div class="p-3 ms-3">BSE</div>
        <div class="p-3 ms-3">MCX</div>
        <div class="p-3 ms-3">Terms & conditions</div>
        <div class="p-3 ms-3"> Policies & procedures</div>
        <div class="p-3 ms-3">Privacy policy</div>
        <div class="p-3 ms-3"> Disclosure</div>
        <div class="p-3 ms-3">For investor attention</div>
        <div class="p-3 ms-3">Investor charter</div>
      </div>
      </div>
    </footer>
  );
