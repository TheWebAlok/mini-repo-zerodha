      ...
      <div className="row p-5">
        ...
        <div className="col-6 p-5">
          ...
          <div className="text-center">
            <a href=""  style={{textDecoration:"none"}} className="mx-5 ">Explore our product<i class="fa fa-long-arrow-right"  aria-hidden="true"></i>
            </a>
            <a href="" style={{textDecoration:"none"}} className="mx-5"> Try Kite demo <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
            </a>
          </div>
        </div>
      </div>
