  ...
  return (
    <footer style={{ backgroundColor: "rgba(250,250,250)" }}>
      ...
      <div  class="d-flex flex-row mb-3 ml-2 ">
        ...
        <div class="p-3 ml-5">BSE</div>
        <div class="p-3 ml-5">MCX</div>
        <div class="p-3 ml-5">Terms & conditions</div>
        <div class="p-3 ml-5"> Policies & procedures</div>
        <div class="p-3 ml-5">Privacy policy</div>
        <div class="p-3 ml-5"> Disclosure</div>
        <div class="p-3 ml-5">For investor attention</div>
        <div class="p-3 ml-5">Investor charter</div>
      </div>
      </div>
    </footer>
  );
