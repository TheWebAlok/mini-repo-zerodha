  ...
  return (
    <footer style={{ backgroundColor: "rgba(250,250,250)" }}>
      ...
      <div  class="d-flex flex-row mb-3 ml-2 ">
        ...
        <div class="p-3 m">BSE</div>
        <div class="p-3 m">MCX</div>
        <div class="p-3 m">Terms & conditions</div>
        <div class="p-3 m"> Policies & procedures</div>
        <div class="p-3 m">Privacy policy</div>
        <div class="p-3 m"> Disclosure</div>
        <div class="p-3 m">For investor attention</div>
        <div class="p-3 m">Investor charter</div>
      </div>
      </div>
    </footer>
  );
