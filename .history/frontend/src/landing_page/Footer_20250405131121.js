  ...
  return (
    <footer style={{ backgroundColor: "rgba(250,250,250)" }}>
      ...
      <div  class="d-flex flex-row mb-3 ml-2 ">
        ...
        <div class="p-3 ms">BSE</div>
        <div class="p-3 ms">MCX</div>
        <div class="p-3 ms">Terms & conditions</div>
        <div class="p-3 ms"> Policies & procedures</div>
        <div class="p-3 ms">Privacy policy</div>
        <div class="p-3 ms"> Disclosure</div>
        <div class="p-3 ms">For investor attention</div>
        <div class="p-3 ms">Investor charter</div>
      </div>
      </div>
    </footer>
  );
